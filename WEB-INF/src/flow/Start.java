...
public class Start extends com.avaya.sce.runtime.Entry {
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Submit submit = new com.avaya.sce.runtime.Submit("report_msg");
		return ( submit );
	}
	/**
	...
	public void initializeVariables(com.avaya.sce.runtimecommon.SCESession session) {
		...
		variableFields = new String[] {
			...
			IProjectVariables.LANGUAGE__MENU_FIELD_INPUTMODE,
			IProjectVariables.LANGUAGE__MENU_FIELD_INTERPRETATION,
			IProjectVariables.LANGUAGE__MENU_FIELD_NOINPUTCOUNT,
			IProjectVariables.LANGUAGE__MENU_FIELD_NOMATCHCOUNT,
