 ...
 * Last generated by Orchestration Designer at: 2022-NOV-29  06:30:54 PM
 */
public class language_menu extends com.avaya.sce.runtime.Menu {
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("English", "1", true, "exact", "Ann_English", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("Tamil", "2", true, "exact", "Ann_Tamil", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("Arabic", "3", true, "exact", "Ann_Arabic", grammarInfo, true);
		list.add(choice);
